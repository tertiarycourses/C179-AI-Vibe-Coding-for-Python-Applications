# Build and Deploy Python Applications with Vibe Coding

**WSQ Course Reference:** TGS-2019504591
**Provider:** Tertiary Infotech Academy Pte Ltd (UEN 201200696W)
**Duration:** 3 days · 8 training hours per day · 9:30 am – 6:30 pm
**Register:** [WSQ Build and Deploy Python Applications with Vibe Coding](https://www.tertiarycourses.com.sg/wsq-build-and-deploy-python-applications-with-vibe-coding.html)

A hands-on WSQ course in which learners build and deploy one real Python
...
| Artifact | File |
|---|---|
| Slide deck (295 slides) | `courseware/Build and Deploy Python Apps with Vibe Coding-v1.6.pptx` |
| Lesson Plan | `courseware/LP-Build and Deploy Python Apps with Vibe Coding.docx` |
| Learner Guide | `courseware/LG-Build and Deploy Python Apps with Vibe Coding.docx` |
| Labs (20) | `labs/` |
...
The assessment set (Written Assessment SAQ and Case Study, each with a question
paper and an answer key) is generated by `build_assessment.py` from
`assessment_data.py` into `assessment/`. Assessment materials are confidential
and are **not** published to this repository.

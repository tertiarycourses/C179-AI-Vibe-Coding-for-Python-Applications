#!/usr/bin/env bash
# Single-command aligned build of all courseware from the single source
...
LP="$CW/LP-Build and Deploy Python Apps with Vibe Coding.docx"
LG="$CW/LG-Build and Deploy Python Apps with Vibe Coding.docx"

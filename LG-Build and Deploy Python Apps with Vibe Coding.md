# Build and Deploy Python Applications with Vibe Coding — Learner Guide

**WSQ Course Code:** TGS-2019504591  |  **Conducted by:** Tertiary Infotech Academy Pte Ltd (UEN 201200696W)  |  **Version v1.6 · 20 July 2026**
...
This Learner Guide accompanies the WSQ course Build and Deploy Python Applications with Vibe Coding (TGS-2019504591), conducted by Tertiary Infotech Academy Pte Ltd. It provides step-by-step instructions for all 20 hands-on labs, organised by the five course topics. Every lab builds part of one real application: CardGuard, a card-transaction fraud screening system written in Python with the help of an AI coding assistant.

Use this guide alongside the course slides and the lab files in the labs/ folder of the course repository. Every lab runs locally with uv — there is no cloud account to create and nothing to pay for. The combined notebook labs/CardGuard-All-Labs.ipynb contains every step in one file.
...
**Install uv and create your first project**

uv installs and manages the Python interpreter, the virtual environment and a lockfile. You never activate a virtual environment by hand — prefix commands with uv run and uv does it for you.
...
A uv project with pyproject.toml, uv.lock and a working entry point   (Tools & libraries: uv, Python 3.12, pyproject.toml, uv.lock.)
...
> **Note:** The full lab — README, Python files and a replayable commands.sh — is in labs/topic1/lab01_*/. Every step is also a cell in labs/CardGuard-All-Labs.ipynb.
...
Two versions of a transaction risk-scoring function and a written comparison of the prompts that produced them   (Tools & libraries: AI coding assistant (Claude / Copilot / Cursor), uv, Python.)
...
> **Note:** The full lab — README, Python files and a replayable commands.sh — is in labs/topic1/lab02_*/. Every step is also a cell in labs/CardGuard-All-Labs.ipynb.
...
A corrected discount calculator plus a short defect log   (Tools & libraries: AI coding assistant, uv, Python.)
...
> **Note:** The full lab — README, Python files and a replayable commands.sh — is in labs/topic1/lab03_*/. Every step is also a cell in labs/CardGuard-All-Labs.ipynb.
...
A refactored sales summary script with an unchanged, verified output   (Tools & libraries: AI coding assistant, uv, Python.)
...
> **Note:** The full lab — README, Python files and a replayable commands.sh — is in labs/topic1/lab04_*/. Every step is also a cell in labs/CardGuard-All-Labs.ipynb.
...
A Transaction class with construction, printing, equality and derived properties   (Tools & libraries: uv, Python 3.12, dataclasses, sqlite3.)
...
> **Note:** The full lab — README, Python files and a replayable commands.sh — is in labs/topic2/lab05_*/. Every step is also a cell in labs/CardGuard-All-Labs.ipynb.
...
A Cardholder class with a protected baseline and a validated update method   (Tools & libraries: uv, Python 3.12.)
...
> **Note:** The full lab — README, Python files and a replayable commands.sh — is in labs/topic2/lab06_*/. Every step is also a cell in labs/CardGuard-All-Labs.ipynb.
...
An abstract FraudRule plus AmountDeviationRule, UnusualHourRule, HighRiskCategoryRule and VelocityRule   (Tools & libraries: uv, Python 3.12, abc.)
...
> **Note:** The full lab — README, Python files and a replayable commands.sh — is in labs/topic2/lab07_*/. Every step is also a cell in labs/CardGuard-All-Labs.ipynb.
...
A RuleEngine returning a ScreeningResult with a composite score and per-rule reasons   (Tools & libraries: uv, Python 3.12.)
...
> **Note:** The full lab — README, Python files and a replayable commands.sh — is in labs/topic2/lab08_*/. Every step is also a cell in labs/CardGuard-All-Labs.ipynb.
...
A loaded, correctly-typed transactions DataFrame plus a spend profile by category   (Tools & libraries: uv, pandas 3.0, sqlite3.)
...
> **Note:** The full lab — README, Python files and a replayable commands.sh — is in labs/topic3/lab09_*/. Every step is also a cell in labs/CardGuard-All-Labs.ipynb.
...
A domain exception hierarchy plus a validated, fail-safe loader   (Tools & libraries: uv, pandas, sqlite3, Python exceptions.)
...
> **Note:** The full lab — README, Python files and a replayable commands.sh — is in labs/topic3/lab10_*/. Every step is also a cell in labs/CardGuard-All-Labs.ipynb.
...
A per-cardholder baseline table and a deviation column on every transaction   (Tools & libraries: uv, pandas 3.0.)
...
> **Note:** The full lab — README, Python files and a replayable commands.sh — is in labs/topic3/lab11_*/. Every step is also a cell in labs/CardGuard-All-Labs.ipynb.
...
A txn_count_10min column plus the burst transactions it exposes   (Tools & libraries: uv, pandas 3.0, rolling windows.)
...
> **Note:** The full lab — README, Python files and a replayable commands.sh — is in labs/topic3/lab12_*/. Every step is also a cell in labs/CardGuard-All-Labs.ipynb.
...
TransactionIn and ScreeningOut Pydantic models with field constraints   (Tools & libraries: uv, Pydantic v2.)
...
> **Note:** The full lab — README, Python files and a replayable commands.sh — is in labs/topic4/lab13_*/. Every step is also a cell in labs/CardGuard-All-Labs.ipynb.
...
A running API with POST /screen, GET /health and automatic OpenAPI docs   (Tools & libraries: uv, FastAPI, uvicorn, Pydantic.)
...
> **Note:** The full lab — README, Python files and a replayable commands.sh — is in labs/topic4/lab14_*/. Every step is also a cell in labs/CardGuard-All-Labs.ipynb.
...
A screenings table plus a repository module with save and query functions   (Tools & libraries: uv, sqlite3, FastAPI.)
...
> **Note:** The full lab — README, Python files and a replayable commands.sh — is in labs/topic4/lab15_*/. Every step is also a cell in labs/CardGuard-All-Labs.ipynb.
...
A passing pytest suite against the screening API   (Tools & libraries: uv, pytest, FastAPI TestClient.)
...
> **Note:** The full lab — README, Python files and a replayable commands.sh — is in labs/topic4/lab16_*/. Every step is also a cell in labs/CardGuard-All-Labs.ipynb.
...
A running Streamlit dashboard with live screening, a review queue and charts   (Tools & libraries: uv, Streamlit, FastAPI, httpx, pandas.)
...
> **Note:** The full lab — README, Python files and a replayable commands.sh — is in labs/topic5/lab17_*/. Every step is also a cell in labs/CardGuard-All-Labs.ipynb.
...
A typed Settings object, a .env file and a .gitignore that excludes it   (Tools & libraries: uv, pydantic-settings, python-dotenv.)
...
> **Note:** The full lab — README, Python files and a replayable commands.sh — is in labs/topic5/lab18_*/. Every step is also a cell in labs/CardGuard-All-Labs.ipynb.
...
A built Docker image running the screening API with a health check   (Tools & libraries: uv, Docker, uvicorn.)
...
> **Note:** The full lab — README, Python files and a replayable commands.sh — is in labs/topic5/lab19_*/. Every step is also a cell in labs/CardGuard-All-Labs.ipynb.
...
A running two-service stack verified with a real screening through the UI   (Tools & libraries: Docker Compose, FastAPI, Streamlit, SQLite.)
...
> **Note:** The full lab — README, Python files and a replayable commands.sh — is in labs/topic5/lab20_*/. Every step is also a cell in labs/CardGuard-All-Labs.ipynb.
...
Courseware and the assessment are on the Tertiary Infotech LMS: https://lms-tms.tertiaryinfotech.com/
